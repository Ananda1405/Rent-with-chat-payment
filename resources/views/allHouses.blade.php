                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card m-3">
                            ...
                            <div class="card-body">
                                <p>
                                    <h4><strong><i class="fas fa-map-marker-alt"> {{ $house->area->name }}, Chattogram</i>
                                        </strong></h4>
                                </p>
                                ...
                                <p class="grey"><a class="code" href="{{ route('house.details', $house->id) }}"><i
                                            class="fas fa-warehouse"> {{ $house->house_code }}</i></a> </p>
                                <hr>
