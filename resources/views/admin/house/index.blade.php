                    ...
                    <div class="table-responsive">
                      <table id="dataTableId" class="table table-bordered table-striped table-background">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('admin.house.approve', $house->id) }}"  class="btn btn-warning btn-sm" >Approved</a>
                            <a href="{{ route('admin.house.show', $house->id) }}"  class="btn btn-success btn-sm">Details</a>
