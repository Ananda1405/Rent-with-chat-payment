...
<head>
    ...
    <title>HouseRental.com - Checkout Hosted | SSLCommerz</title>
...
<div class="container">
    <div class="py-5 text-center">
        <h1 style="color: blue">HouseRental.com</h1>
        <h2>Payment Authorization Form</h2>
        <p>Powerd by: SSLCommerz</p>
        <p style="color:red">You need to Pay <strong>{{ $price }}</strong> BDT. To add this House.</p>
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2 order-md-1">
            ...
            <form action="{{ url('/checkout') }}" method="POST" class="needs-validation">
                ...
                <input type="hidden" name="house_id" class="form-control" value="{{$house_id}}">
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2020 Houserental.com</p>
