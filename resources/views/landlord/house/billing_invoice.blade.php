        ...
        <div class="invoice-header">
            <div class="invoice-flex-contents">
                <div class="invoice-logo">
                    <img style="height: 100px; width: 100px;" src="{{ public_path('frontend/img/ovilogo.png') }}" alt="">
                </div>
            ...
            <div class="table-responsive">
                ...
                <table class="custom--table">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="data-span"> {{ __('House Add Fee:') }} </span> {{ $order->amount }} <br>
