    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p> <i class="fas fa-map-marker-alt"></i> House Rental, Bohodarhat, Chattogram</p>
            <p><i class="fas fa-phone"></i> +88 0152222222</p>
            <p><i class="fas fa-envelope"></i> ovi@gmail.com</p>
          </div>
