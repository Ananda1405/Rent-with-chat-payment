<header>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-4">
        <div>
          <a href="{{ route('welcome') }}"> <img src="{{ asset('frontend/img/ovilogo.png') }}"
              style="height: 120px; width: 140px" alt="logo" class="my-2 mx-2 text-center">
          </a>
      ...
      <div class="col-sm-8">
        <h1 style="font-size: 2.5rem; margin-top: 45px; font-weight: 700; color: REBECCAPURPLE;">
          Welcome to Ctg House Rental.com
        </h1>
      </div>
    </div>
  </div>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('renter.view.wishlist') }}">Wishlist</a></li>
